...
-- 1. Check for bookings with NULL or empty barber_id or service_id
...
-- WHERE barber_id IS NULL OR barber_id = '' OR service_id IS NULL OR service_id = '';
...
-- CHECK (barber_id IS NOT NULL AND barber_id != '' AND service_id IS NOT NULL AND service_id != '');
